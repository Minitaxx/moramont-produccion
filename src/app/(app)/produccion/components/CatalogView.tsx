    ...
    <div className="space-y-6">
      <div>
        <p className="mb-1 text-sm text-gray-500">
          {selectedProduct ? (
            <span className="cursor-pointer hover:text-gray-700" onClick={() => setSelectedProduct(null)}>
        ...
        {selectedProduct && (
          <p className="mt-1 text-sm text-gray-500">
            {selectedProduct.code} · {selectedProduct.geometryType} · {selectedProduct.productType}
          </p>
        )}
      </div>
      {!selectedProduct ? (
        ...
        <ProcessManager product={selectedProduct} onBack={() => setSelectedProduct(null)} />
      )}
    </div>
  )
}
